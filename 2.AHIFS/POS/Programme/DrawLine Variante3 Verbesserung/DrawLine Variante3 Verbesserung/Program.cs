...
namespace DrawLine_Variante3_Verbesserung
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ÜbergabeDerLinien(Lines);

            Console.SetCursorPosition(0, 20);
        }

        static void ÜbergabeDerLinien(int[,] Linien)
        {
            int linienNummer;
            ...
            {
                drawline(Linien[ZählerDerLinien, 0], Linien[ZählerDerLinien, 1], Linien[ZählerDerLinien, 2], Linien[ZählerDerLinien, 3]);
            }
        }

        static void drawline(int StartX, int StartY, int Length, int Direction)
        {
            int senkrecht = 0;
            int waagerecht = 0;
