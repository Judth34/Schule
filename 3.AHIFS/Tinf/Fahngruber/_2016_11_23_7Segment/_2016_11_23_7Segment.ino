...
{
  byte numDigits = 4;   
  byte digitPins[] = {0, 3, 1, 2}; //Digits: 1,2,3,4 <--put one resistor (ex: 220 Ohms, or 330 Ohms, etc, on each digit pin)
  byte segmentPins[] = {11, 10, 5, 8, 4, 9, 7, 6}; //Segments: A,B,C,D,E,F,G,Period
