...
public class NewBook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response, "type in all book properties (hits:" + Database.getHits() + ")");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            processRequest(request, response, "new Book inserted");
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response, String message) throws IOException{
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<!DOCTYPE html>\n" +
                        ...
                        "      <div class=\"form\">\n" +
                        "    <h1>New Book</h1>\n" +
                        "        <form class=\"login-form\" method=\"post\" action=\"http://localhost:8080/007_Books_Servlet/NewBook\">\n" +
                        "          <input type=\"number\" name=\"id\" placeholder=\"id\"/>\n" +
                        "          <input type=\"text\" name=\"author\" placeholder=\"author\"/>\n" +
                        "          <input type=\"text\" name=\"title\" placeholder=\"title\"/>\n" +
                        "          <input id=\"formButton\" type=\"submit\" name=\"\" value=\"Insert\"/>\n" +
                        "           <p class=\"message\">Type in all book prperties</p>\n" +
                        "        </form>\n" +
                        "      </div>\n" +
                        "    </div>\n" +
                        "  </body>\n" +
